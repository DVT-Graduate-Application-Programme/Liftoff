...
public static class ApplicationRecordSeeder
{
    ...
    {
        logger.LogInformation("[ApplicationRecordSeeder] Truncating existing data to re-seed POC data…");
        await db.Database.ExecuteSqlRawAsync("""TRUNCATE TABLE "ApplicationRecords" CASCADE;""");

        logger.LogInformation("[ApplicationRecordSeeder] Seeding POC application data…");

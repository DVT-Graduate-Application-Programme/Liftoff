...
public static class DbSeeder
{
    ...
    public static async Task SeedAsync(IServiceProvider serviceProvider)
    {
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            VALUES
                ('c1000000-0000-0000-0000-000000000001', 'recruiter-seed-001', 'Naledi',  'Dlamini', 'naledi.dlamini@dvt.co.za',  TRUE, NOW(), NOW()),
                ('c2000000-0000-0000-0000-000000000002', 'recruiter-demo',     'Sipho',   'Ndlovu',  'sipho.ndlovu@dvt.co.za',    TRUE, NOW(), NOW())
